<!-- Topbar -->
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-3 static-top shadow">
                ...
                @if (Route::currentRouteName() == 'pemaspenge')
                    <div id="fieldTanggalLaporan" style="display: none">
                        <button class="btn btn-secondary btn-sm" onclick="closeDetailMode()">
                            <i class="fas fa-times"></i>
                        </button>
                        <button class="btn btn-primary btn-sm" aria-readonly="true" id="labelTanggalDetailLaporan">
                            TANGGAL LAPORAN
                        </button>
                    </div>
                @endif
