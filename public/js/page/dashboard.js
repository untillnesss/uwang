...
function tambahkanSaldoAwal() {
    Swal.fire({
        title:
            "Karena anda adalah member baru, jumlah saldo anda tidak ditemukan",
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    if (d == "y") {
                        a(
                            "Berhasil !",
                            "Berhasil menambahkan saldo awal",
                            "success"
                        );
                        getSaldo();
                        getChartSaldo();
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data[1], function (i, d) {
                if (d == null) {
                    tanggal.push("Saldo Awal");
                } else {
                    tanggal.push(penanggalan(d));
                }
            });
...
$.ajax({
    ...
    success: function (data) {
        ...
        $.each(data, function (i, d) {
            tanggal.push(penanggalan(d.tanggal));
